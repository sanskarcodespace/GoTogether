...
const rideRequestSchema = new mongoose_1.Schema({
    ride: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Ride', required: true, index: true },
    seeker: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
    pickupLocation: {
...
const RideRequest = mongoose_1.default.model('RideRequest', rideRequestSchema);
