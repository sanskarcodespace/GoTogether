...
const ride_validator_1 = require("./ride.validator");
const validateMiddleware_1 = require("../../middleware/validateMiddleware");
const authMiddleware_1 = require("../../middleware/authMiddleware");
const router = (0, express_1.Router)();
router.use(authMiddleware_1.protect);
router.post('/create', (0, authMiddleware_1.restrictTo)('user'), (0, validateMiddleware_1.validate)(ride_validator_1.createRideSchema), rideController.createRide);
router.get('/search', (0, validateMiddleware_1.validate)(ride_validator_1.searchRideSchema), rideController.getAvailableRides);
...
// Ride Requests
router.post('/:rideId/requests', (0, validateMiddleware_1.validate)(ride_validator_1.createRequestSchema), rideController.requestRide);
